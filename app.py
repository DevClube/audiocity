...
class TextToAudioConverterApp:
    def __init__(self, root):
        ...
        self.progressbar = tk.CTkProgressBar(self.main_frame, orientation="horizontal",width=400)
    ...
    def convert_text_to_audio(self):
        ...
        try:
            ...
            CTkMessagebox(title="Error",message=f"An error occurred: {str(e)}",icon="check", option_1="close")
